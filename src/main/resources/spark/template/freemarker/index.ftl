...
<div class="jumbotron text-center">
  <div class="container">
    ...
    <h1>Looking for a Restaurant in Seoul</h1>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <ul>
        <li>This app was deployed to Heroku by Sanghoon, either using Git or by using <a href="https://github.com/heroku/java-getting-started">Heroku Button</a> on the repository.</li>
